...
async function POST(req) {
    try {
        ...
        return new Response(JSON.stringify({
            error: 'Error al revalidar la página raíz'
        }), {
            status: 500
        });
    }
}
const GET = ()=>new Response('Método no permitido', {
        status: 405
    });
}}),
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__b3d3ad._.js.map